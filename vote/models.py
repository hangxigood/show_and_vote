...
class Subject(models.Model):
    ...
    creat_date = models.DateField(null=True, verbose_name='成立日期')
    is_hot = models.BooleanField(default=False, verbose_name='是否热门')

    def __str__(self):
        return self.name

    class Meta:  # 元数据，在数据库中编著
        db_table = 'db_subject'
        verbose_name = '学科'
...
class Teacher(models.Model):
    ...
    subject = models.ForeignKey(Subject, on_delete=models.PROTECT, db_column='sno', verbose_name='所属学科')
